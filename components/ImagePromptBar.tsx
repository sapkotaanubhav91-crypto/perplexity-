...
const ImagePromptBar: React.FC<ImagePromptBarProps> = ({ prompt, setPrompt, onGenerate, isLoading }) => {
  ...
  return (
    <div className="relative w-full max-w-2xl">
      <input
        ...
        disabled={isLoading}
        className="w-full pl-5 pr-36 py-4 bg-slate-800 border border-slate-700 rounded-full text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
      />
      <button
        onClick={onGenerate}
        disabled={isLoading}
