    ...
    <header className="fixed top-0 left-0 right-0 p-4 bg-white z-10">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center gap-4 text-sm font-medium text-gray-700">
          ...
          <div className="flex items-center gap-2">
            <div className="flex flex-col text-left">
                <span className="font-semibold">Krut AI Assistant</span>
                <span className="text-xs text-gray-500">kruti.ai</span>
            </div>
        ...
        <div className="flex items-center gap-2">
            ...
            <button className="p-2 rounded-full hover:bg-gray-100" aria-label="Language">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 01-3.827-5.802" />
                </svg>
            </button>
            <button className="px-5 py-2 bg-black text-white text-sm font-semibold rounded-lg">Login</button>
        </div>
      </div>
    </header>
  );
